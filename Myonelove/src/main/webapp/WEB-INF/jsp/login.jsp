...
<html>
<head>
<title>欢迎来到myone</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<script src="js/jquery-1.9.0.min.js" charset="UTF-8" type="text/javascript"></script>
<script src="images/login.js" charset="UTF-8" type="text/javascript"></script>
<link href="css/login2.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<h1>
		欢迎来到MYONELOVE<sup>V2018</sup>
	</h1>
	...
	<div class="login" style="margin-top: 50px;">
			...
			<div class="web_login" id="web_login">
				...
				<div class="login-box">
					...
					<div class="login_form">
						<form action="mUserInfoAction/login" name="loginform" accept-charset="utf-8"
							...
							<div class="uinArea" id="uinArea">
								...
								<div class="inputOuter" id="uArea">
									...
									<input type="text" id="u" name="mobilephone" class="inputstyle" />
								</div>
							</div>
		...
		<div class="qlogin" id="qlogin" style="display: none;">
			...
			<div class="web_login">
				<form name="form2" id="regUser" accept-charset="utf-8" action="mUserInfoAction/regUser"
					method="post">
					...
					<ul class="reg_form" id="reg-ul">
						...
						<li><label for="user" class="input-tips2">手机号：</label>
							<div class="inputOuter2">
								<input type="text" id="user" name="mobilephone" maxlength="16"
									class="inputstyle2" />
							</div></li>
